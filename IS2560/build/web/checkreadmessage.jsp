...
<html>
    <head>
        ...
        <% if (session.getAttribute("email") == null) {session.setAttribute("email", "wil@pitt.edu");}String email = session.getAttribute("email").toString();
            int num = DBBean.countreadmessage(email);
        ...
        <div class="container">
            ...
            <div class="col-md-12 column">
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li role="presentation" class="active"><a href="checkreadmessage.jsp">Already has been read</a></li>
                ...
                <% 
                    ...
                    Object[][] mess = DBBean.showreadmessage(email);
                    if (mess != null) {
                        int i;
                        for (i=0; i<num;i++){
                %>
